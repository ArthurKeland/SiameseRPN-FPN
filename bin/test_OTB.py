...
sys.path.append('/') # Input your own project directory
...
if __name__ == '__main__':
    ...
    # model_paths = ['model/siamrpn_50.pth']
    # ------------ prepare models  -----------
    ...
    for model_path in model_paths:
        ...
        for video_path in video_paths:
            ...
            np.savetxt('results/'+video_path.split('/')[-1]+'.txt',result_boxes)
            results[model_path][video_path.split('/')[-1]] = [box.tolist() for box in result_boxes]
